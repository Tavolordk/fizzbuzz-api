...
const rawdata = fs.readFileSync("explorer.json");
...
const assignBuzzOrFizzOrFizzBuzzTrick = (explorer)=>{
    if(explorer.score%5 === 0 && explorer.score%3 === 0){
        explorer.trick = "FIZZBUZZ";
        return explorer;
...
const explorersInNodeAndTellMeIFIsFizzOrBuzzOrFizBuzz = explorersInNode.map((explorer)=>assignBuzzOrFizzOrFizzBuzzTrick(explorer));
console.log(explorersInNodeAndTellMeIFIsFizzOrBuzzOrFizBuzz);